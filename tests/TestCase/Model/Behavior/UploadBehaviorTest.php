...
class UploadBehaviorTest extends TestCase
{
    ...
    {
        parent::setUp();
		$this->schema = $this->getMock('Schema', ['columnType']);
		$methods = get_class_methods('Cake\ORM\Table');
		$this->Table = $this->getMock('Cake\ORM\Table', $methods);
	...
	public function testBeforeMarshalOk()
    {
        ...
        $behavior = $this->getMock('Dala00\Upload\Model\Behavior\UploadBehavior', $methods, [$table, $this->settings]);
	...
	public function testSave() {
		...
		$entity = $this->getMock('Cake\ORM\Entity', ['get', 'set']);
		$defaultValue = [
			'name' => 'filename',
			'tmp_name' => 'tmp_name',
			'size' => 5,
